...
?='';  do until length(?)==4           /*generate unique 4-digit number.*/
       r=random(1,9)                   /*change  1âââº0  to allow a 0 dig*/
...
prompt='[Bulls & Cows game] ',         /*build the prompt text string.  */
  ...
  g=?;  L=length(n);  bulls=0;  cows=0
                                       /*bull countâââââââââââââââââââââ*/
       ...
       g=overlay(' ',g,j)              /*disallow this for a cow count. */
                                       ...
                                       /*cow  countâââââââââââââââââââââ*/
  ...
  if bulls\==4 then say "âââââ You got" bulls 'bull's(bulls) "and" cows 'cow's(cows)"."
  end       /*until bulls==4*/

say;   say "          âââââââââââââââââââââââââââââââââââââââââââ"
       say "          â                                         â"
       say "          â  Congratulations, you've guessed it !!  â"
       say "          â                                         â"
       say "          âââââââââââââââââââââââââââââââââââââââââââ";    say
exit
