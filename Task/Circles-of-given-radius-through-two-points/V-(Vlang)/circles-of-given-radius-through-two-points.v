...
const two = 'two circles.'
const r0 = 'R==0.0 does not describe circles.'
const co = 'coincident points describe an infinite number of circles.'
const cor0 = 'coincident points with r==0.0 describe a degenerate circle.'
const diam = 'Points form a diameter and describe only a single circle.'
const far = 'Points too far apart to form circles.'
