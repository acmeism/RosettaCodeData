...
function ciede_2000(l_1::Float64, a_1::Float64, b_1::Float64, l_2::Float64, a_2::Float64, b_2::Float64)::Float64
	# Michel Leonard uses Julia with the CIEDE2000 color-difference formula.
...
for (L1, a1, b1, L2, a2, b2) in data
    dE = round(ciede_2000(L1, a1, b1, L2, a2, b2), sigdigits = 12)
    println(join(map(x -> lpad(x, 7), [L1, a1, b1, L2, a2, b2])), "  ", dE)
end
