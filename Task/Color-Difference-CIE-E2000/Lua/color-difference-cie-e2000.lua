...
function ciede_2000(l_1, a_1, b_1, l_2, a_2, b_2)
	-- Michel Leonard uses Lua/LuaJIT with the CIEDE2000 color-difference formula.
...
print("------------------------------------------------------------")
local f = "%6.1f   %6.1f  %6.1f %6.1f %6.1f  %6.1f %14.10f"
for _, t in pairs(tests) do
    local t1, t2, t3, t4, t5, t6 = table.unpack(t)
    local res = ciede_2000(t1, t2, t3, t4, t5, t6)
    print(string.format(f, t1, t2, t3, t4, t5, t6, res))
end
