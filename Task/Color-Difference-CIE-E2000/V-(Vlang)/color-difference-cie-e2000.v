...
fn ciede_2000(l_1 f64, a_1 f64, b_1 f64, l_2 f64, a_2 f64, b_2 f64) f64 {
    ...
    k_c := 1.0
    k_h := 1.0
	mut n := (math.hypot(a_1, b_1) + math.hypot(a_2, b_2)) * 0.5
	n = n * n * n * n * n * n * n
	// GitHub Project :
	...
	mut h_1 := math.atan2(b_1, a_1 * n)
	mut h_2 := math.atan2(b_2, a_2 * n)
...
fn main() {
    ...
    for t in tests {
        ...
        println('${t[0]:6.1f}   ${t[1]:6.1f}  ${t[2]:6.1f} ${t[3]:6.1f} ${t[4]:6.1f}  ${t[5]:6.1f} ${res:14.10f}')
    }
}
