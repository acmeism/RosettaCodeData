      ...
      (if (>= i (rows grid))
          ...
          (if (>= j (cols grid))
              ...
              (if (= (2d-ref grid i j) 1)
                  (loop (underlay/xy img (* i (+ 1 size)) (* j (+ 1 size)) (square (- size 2) "solid" "black")) i (+ j 1))
                  (loop img i (+ j 1))))))))



(define (game-of-life grid refresh_time)
  (animate (lambda (n) (if (= (modulo n refresh_time) 0)
...
(define (blinker) (make-grid 3 3 '((0 1) (1 1) (2 1))))

(define (thunder) (make-grid 70 50 '((30 19) (30 20) (30 21) (29 17) (30 17) (31 17))))
