...
struct IntegerTriangle{T <: Integer}
    a::T
    b::T
    c::T
    p::T
...
function IntegerTriangle(a::T, b::T, c::T) where T <: Integer
    p = a + b + c
    s = div(p, 2)
...
function isprimheronian(a::T, b::T, c::T) where T <: Integer
    p = a + b + c
...
function testprimerheronian()
    ...
    print("The number of primitive Heronian triangles having sides ≤ ")
