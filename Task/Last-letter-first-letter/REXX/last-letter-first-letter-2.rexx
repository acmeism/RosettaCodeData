...
/*──────────────────────────────────────────────────────────────────────────────────────*/
build@:  !.=0;    do i=1  for #;  @.i=word(@, i) /*build a stemmed array from the list. */
                  F= left(@.i, 1);   !.1.F=!.1.F + 1           /*count first characters.*/
                  L=right(@.i, 1);   !.9.L=!.9.L + 1           /*count  last characters.*/
                  end   /*i*/
return
/*──────────────────────────────────────────────────────────────────────────────────────*/
...
scan: procedure expose @. MP # !. MPL $$$;     parse arg $$$,!;                 _=!-1
      ...
      if !.1.LC==0  then return                  /*is this a  dead-end  word?           */
          ...
          if _==LC  then do                      /*is the first-character = last-char?  */
