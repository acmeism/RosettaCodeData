let elements="hydrogen helium lithium beryllium boron carbon nitrogen oxygen fluorine \
...
let n=elements.Split (" ") in printfn "As of %s there are %d elements, the highest is %s" ("February 17th., 2026") n.Length (n|>Array.last)
