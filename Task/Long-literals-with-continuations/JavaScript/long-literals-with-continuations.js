// JavaScript's continuation character is the backslash (\)
let revdate = new Date(2026, 2, 17);
...
console.log(`Last revision date: ${revdate}`);
console.log(`Number of elements: ${elements_array.length}`);
console.log(`Last element: ${elements_array.at(-1)}`);
