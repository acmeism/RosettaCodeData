/*REXX program creates/displays an ASCII art version of the  Yin-Yang  symbol.*/
parse arg s1 s2 .                      /*obtain optional arguments from the CL*/
if s1=='' | s1==','  then s1=17        /*Not defined?   Then use the default. */
if s2=='' | s2==','  then s2= 8        /* "      "        "   "   "     "     */
if s1>0  then call yin_yang  s1        /*create and display the 1st Yin-Yang. */
...
/*────────────────────────────────────────────────────────────────────────────*/
yin_yang: procedure; parse arg r;  mY=1; mX=2 /*scale multiplier for X,Y axis.*/
WH='·';    BL='@';   zz=' '            /*define some symbol shading (glyphs). */
